...
public class EditCommandParser implements Parser<EditCommand> {
    ...
    public EditCommand parse(String args) throws ParseException {
        requireNonNull(args);
        ArgumentMultimap argMultimap = ArgumentTokenizer.tokenize(args, PREFIX_NAME, PREFIX_PHONE, PREFIX_COMPANY,
    ...
    /**
     * Parses {@code Collection<String> products} into a {@code Set<Product>} if
     * {@code products} is non-empty.
     * If {@code products} contain only one element which is an empty string, it
     * will be
     * parsed into a
    ...
    private Optional<Set<Product>> parseProductsForEdit(Collection<String> products) throws ParseException {
        ...
        Collection<String> productSet = products.size() == 1 && products.contains("") ? Collections.emptySet()
                : products;
