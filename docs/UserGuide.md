...
Examples:
* `add n/John Doe p/98765432 c/meta e/johnd@example.com a/John street, block 123, #01-01`
* `add n/Betsy Crowe t/friend c/apple e/betsycrowe@example.com a/Newgate Prison p/1234567 t/criminal`
...
-----------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------
**Add**    | `add n/NAME p/PHONE_NUMBER c/COMPANY e/EMAIL a/ADDRESS [t/TAG]…​` <br> e.g., `add n/James Ho p/22224444 e/jamesho@example.com a/123, Clementi Rd, 1234665 t/friend t/colleague`
**Clear**  | `clear`
